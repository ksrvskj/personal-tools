...
- **Paper 2** — рабочие страницы статьи: план введения и карта содержания (ссылки внизу главной).

## Структура

```
style.css       <- общие стили, шрифты и переменные
icons.js        <- общие SVG-иконки (главная, рецепты, кофе)
lang.js         <- общий переключатель RU/EN (t, setLang, applyLang)
...
paper_map.html  <- карта содержания Paper 2
intro_outline.html <- план введения Paper 2
```
...
- Раздел нидерландского: `?g=basics&lang=en`
